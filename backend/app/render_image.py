...
# Pure white -- the *only* thing in any grid-based view that renders as white (see
# elevation_colors' own stops, none of which reach pure white even at the highest peaks), so
# white reads unambiguously as "ice cover" (this node's glacier_depth, whatever drove it --
# a high cold peak or a low-lying polar cap, both use the same field) rather than "tall
# mountain" or "lake."
GLACIER_COLOR_RGB = (255, 255, 255)
