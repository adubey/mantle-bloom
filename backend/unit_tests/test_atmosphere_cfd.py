...
def _world(seed=1, num_plates=8, climate_density=0.5, steps=1, years=5_000_000):
    # fluid_density=climate_density -- atmosphere_cfd sizes its own grid off fluid_density
    # (see World.fluid_density's own docstring), independent of climate_density since
